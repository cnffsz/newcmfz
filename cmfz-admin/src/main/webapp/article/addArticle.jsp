...
<div style="margin-top: 35px;margin-left: 75px">
        ...
        <a id="btnClear" onclick="clearArticle()" class="easyui-linkbutton" data-options="iconCls:'icon-database_refresh'">重置文本内容</a>
...
<script type="text/javascript">
    ...
    editor.customConfig.uploadImgServer = '${pageContext.request.contextPath}/article/upload';  // 上传图片到服务器的controller
